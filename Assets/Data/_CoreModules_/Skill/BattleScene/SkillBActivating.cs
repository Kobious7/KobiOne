...
public class SkillBActivating : SkillBAb
{
    ...
    private IEnumerator TileSkillActive(SkillNode skill, SkillButton button)
    {
        ...
        Game.Instance.Player.BattleStats.ManaDes(tileSkill.ManaCost);
    ...
    private void OpSkillActive(SkillNode skill, SkillButton button)
    {
        ...
        Game.Instance.Opponent.Stats.HPDes(finalDamage);
    ...
    public void ApplyDebuff(SkillNode skill, OpponentStats stats)
    {
    ...
    public void ApplyBuff(SkillNode skill, IEntityBattleStats stats)
    {
        int level = skill.Level;

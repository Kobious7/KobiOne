...
public class BEntityStats : EntityComponent
{
    ...
    public int DamageCalculate(int rawDamage, BEntityStats receiver)
    {
    ...
    public void DealDamage(int rawDamage, BEntityStats receiver)
    {

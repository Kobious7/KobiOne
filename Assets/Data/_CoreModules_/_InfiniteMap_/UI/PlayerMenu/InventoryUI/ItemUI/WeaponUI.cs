...
public class WeaponUI : GMono
{
    ...
    private void Click()
    {
        ...
        if(WeaponUISpawner.Instance.SelectedItem != null) WeaponUISpawner.Instance.SelectedItem.gameObject.SetActive(true);
        onSelectObject.gameObject.SetActive(false);

        WeaponUISpawner.Instance.SelectedItem = onSelectObject;
    }
}
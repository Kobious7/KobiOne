...
public class TileDragging : TileBoardAb
{
    ...
    public void ChangePos()
    {
        ...
        int tileX = Tile.TileProperties.X;
        int tileY = Tile.TileProperties.Y;
        TileBoard tile = GetTile(tiles[tileX, tileY]);
    ...
    private bool MoveTile(TileBoard tile, int x, int y)
    {

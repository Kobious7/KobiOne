...
namespace InfiniteMap
{
    public class HelmetUI : GMono
    {
        ...
        public void ShowHelmet(InventoryEquip item)
        {
        ...
        private void Click()
        {
            if(!onSelectObject.gameObject.activeSelf)
            {
                if(Time.time - lastTimeClick < doubleClickTheshold)
                {
                    ...
                    EquipDetailsUI.Instance.ShowEquip(Game.Instance.Inventory.HelmetList[index]);
                }
            ...
            if(HelmetUISpawner.Instance.SelectedItem != null) HelmetUISpawner.Instance.SelectedItem.gameObject.SetActive(true);
            onSelectObject.gameObject.SetActive(false);

            HelmetUISpawner.Instance.SelectedItem = onSelectObject;
        }
    }
}
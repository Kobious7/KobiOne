...
namespace InfiniteMap
{
    public class BackItemUI : GMono
    {
        ...
        public void ShowBackItem(InventoryEquip item)
        {
        ...
        private void Click()
        {
            if(!onSelectObject.gameObject.activeSelf)
            {
                if(Time.time - lastTimeClick < doubleClickTheshold)
                {
                    ...
                    EquipDetailsUI.Instance.ShowEquip(Game.Instance.Inventory.BackItemList[index]);
                }
            ...
            if(BackItemUISpawner.Instance.SelectedItem != null) BackItemUISpawner.Instance.SelectedItem.gameObject.SetActive(true);
            onSelectObject.gameObject.SetActive(false);

            BackItemUISpawner.Instance.SelectedItem = onSelectObject;
        }
    }
}
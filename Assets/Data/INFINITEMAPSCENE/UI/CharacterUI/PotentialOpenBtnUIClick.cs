...
{
    public class PotentialOpenBtnUIClick : GMono
    {
        ...
        {
            if(!potential.gameObject.activeSelf) potential.gameObject.SetActive(true);
            if(!statSpawner.gameObject.activeSelf) statSpawner.gameObject.SetActive(true);
            if(!preview.gameObject.activeSelf) preview.gameObject.SetActive(true);
            if(equipment.gameObject.activeSelf) equipment.gameObject.SetActive(false);

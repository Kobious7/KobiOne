...
[CustomPropertyDrawer(typeof(HideByTileAttribute))]
public class HideByTileAttributeDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        // Find the Skill script that this property belongs to
        TileSkillSO skill = property.serializedObject.targetObject as TileSkillSO;
        ...
        if (skill != null && property.propertyType == SerializedPropertyType.Enum)
        {
            ...
            filteredEnumNames = System.Array.FindAll(enumNames, name => !name.Contains(mainTargetValue.ToString()));

...
[CustomPropertyDrawer(typeof(HideBySelfAttribute))]
public class HideBySelfAttributeDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        // Find the Skill script that this property belongs to
        SelfSkillSO skill = property.serializedObject.targetObject as SelfSkillSO;

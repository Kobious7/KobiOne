...
public class DebuffSpawner : Spawner
{
    ...
    public void SpawnDebuffs(int level, List<ActiveDebuff> debuffs, EntityStats stats)
    {
        GetCurrentDebuff();
    ...
    public void SpawnNewDebuff(int level, ActiveDebuff debuff, EntityStats stats)
    {
